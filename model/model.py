...
from inputs import extract_data, resize_with_pad, IMAGE_SIZE

path = r'.\HASSIO_Facial_Recognition\model'
...
class Dataset(object):
    ...
    # Two classes to start, Zach & Sydney
...
class Model(object):
    ...
    FILE_PATH = r'.\HASSIO_Facial_Recognition\model\model.h5'
